...
const TABS = [
  ...
  { to: '/projects/$projectId/cohorts', label: 'Cohorts', exact: false },
  { to: '/projects/$projectId/reports', label: 'Reports', exact: false },
  { to: '/projects/$projectId/dashboards', label: 'Dashboards', exact: false },
