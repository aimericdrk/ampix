...
describe('HistogramChart', () => {
  ...
  it('lists range, count, and percent-of-total in the accessible table (unit: number)', () => {
  ...
  it('formats bucket ranges as durations when unit is duration', () => {
    render(
      <HistogramChart
  ...
  it('formats bucket ranges as currency when unit is currency', () => {
    render(
      <HistogramChart
  ...
  it('collapses a zero-width bucket to a single value instead of duplicating the bound', () => {
  ...
  it('shows a dash instead of a percent when there is no data', () => {
